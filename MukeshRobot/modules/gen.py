...
async def gen_session(
    ...
    await Client.send_message(user_id, "» ᴛʀʏɪɴɢ ᴛᴏ sᴇɴᴅ ᴏᴛᴩ ᴀᴛ ᴛʜᴇ ɢɪᴠᴇɴ ɴᴜᴍʙᴇʀ...")
    if telethon:
    ...
    try:
        ...
        return await Client.send_message(user_id, f"ᴇʀʀᴏʀ : <code>{str(ex)}</code>")
    ...
    try:
        ...
        if telethon:
            ...
            await client.send_message(
                "me",
                txt.format(ty, string_session, OWNER_ID),
                link_preview=False,
                parse_mode="html",
            )
                ...
                [
                    [
                        InlineKeyboardButton(
                            text="sᴀᴠᴇᴅ ᴍᴇssᴀɢᴇs",
                            url=f"tg://openessage?user_id={user_id}",
                        )
                    ]
                ]
            ),
