            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url="https://t.me/+ZMyP7TolTXkxMjRl"),
                    ],
                    [
                        InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="Main_help"),
                    ],
...
❏ *𝙐𝙎𝙀𝙍𝘽𝙊𝙏 𝙂𝘾𝘼𝙎𝙏 
├ ʀᴘ. 40.000  [ ʙᴜʟᴀɴᴀɴ ᴜsᴇʀʙᴏᴛ ᴜʟᴛʀᴏɪᴅ ]
╰ sɪsᴛᴇᴍ ᴛᴇʀɪᴍᴀ ᴊᴀᴅɪ*
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url=f"tg://user?id={OWNER_ID}"),
                        InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url="https://t.me/comfortzonechh"), 
                    ],
                    [
                        InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="Main_help")]]
            ),
        ...
        first_name = update.effective_user.first_name
        query.message.edit_caption(
            PM_START_TEXT.format(escape_markdown(uptime), BOT_NAME),
            reply_markup=InlineKeyboardMarkup(buttons),
            parse_mode=ParseMode.MARKDOWN,
            timeout=60,
        )
